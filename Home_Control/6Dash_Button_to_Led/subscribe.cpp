...
#define TOPIC       "ChrisCprag/feeds/homecontrol.dash-switch"
...
int msgarrvd(void *context, char *topicName, int topicLen, MQTTClient_message *message) {
    GPIO external_LED(60);
    external_LED.setDirection(OUTPUT);
    char* payloadptr;
    ...
    if(*(payloadptr+1) == 'N'){
      external_LED.setValue(HIGH);
    }
    else{
      external_LED.setValue(LOW);
    }
